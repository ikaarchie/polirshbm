                    ...
                    if(panggil_antrian.length > 0){
                        for(let i=0; i<panggil_antrian.length; i++){
                            html += '<tr>\
                                    ...
                                    <td>'+panggil_antrian[i]['status_panggil']+'</td>\
                                    <td class="text-center">\
                                        <div class="d-grid gap-1 d-sm-flex justify-content-sm-center">\
                                        <a href="savepanggilReg/' + panggil_antrian[i]['id'] + '" class="btn btn-sm btn-success">Panggil</a>\
                                        <a href="savependingReg/' + panggil_antrian[i]['id'] + '" class="btn btn-sm btn-warning">Pending</a>\
                                        <a href="saveselesaiReg/' + panggil_antrian[i]['id'] + '" class="btn btn-sm btn-danger">Selesai</a>\
                                        </div>\
                                    </td>\
                                </tr>';
                        }
